    ...
    <div className="container-landing-pg flex">
        <div className="text-section">
           ...
           <div className="flex-column">
            ...
            <p className="brand-description  mg-x-sm mg-bottom-xlg fw-bold secondary-color">Create and Save your Notes, Tasks, Ideas, Important Info, Links before missing out. Systematically Organize them to quickly access it.</p>
            </div>
